...
from structuresML import Text_space as Text
...
class Wikiwho:
    ...
    def printRevision(self, revisions, params, format = "json"):
        ...
        print simplejson.dumps(response)
        import io
        json_folder = '/home/lxadmin/wikiwho/test_jsons'
        json_file_path = '{}/{}.json'.format(json_folder, self.article)
        with io.open(json_file_path, 'w', encoding='utf-8') as f:
            f.write(simplejson.dumps(response, indent=4, separators=(',', ': '), sort_keys=True, ensure_ascii=False))
        # change pickle folder in ww_api_api.py to test_jsons/
        # scp -r lxadmin@193.175.238.123:/home/lxadmin/wikiwho/test_jsons/ /home/kenan/PycharmProjects/wikiwho_api/server_jsons
