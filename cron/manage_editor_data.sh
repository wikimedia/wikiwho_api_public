...
logs_folder=$logs_folder$current_ym
python ../manage.py fill_editor_tables -from current_ym -to next_ym -m 12 -log logs_folder -lang 'en,de,eu'
echo 'fill_editor_tables is finished, starting manage_editor_tables'
python ../manage.py manage_editor_tables -from current_ym -to next_ym -m 12 -log logs_folder -lang 'en,de,eu'
