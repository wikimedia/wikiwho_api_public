...
echo $(which python)
python /home/nuser/wikiwho_api/manage.py fill_editor_tables -from $last_ym -to $current_ym -m 12 -log $logs_folder -lang 'en,de,eu'
echo 'fill_editor_tables is finished, starting manage_editor_tables'
python /home/nuser/wikiwho_api/manage.py manage_editor_tables -from $last_ym -to $current_ym -m 12 -log $logs_folder -lang 'en,de,eu'
echo 'manage_editor_tables is finished, starting empty_editor_tables'
python /home/nuser/wikiwho_api/manage.py empty_editor_tables -m 12 -log $logs_folder -lang 'en,de,eu'
